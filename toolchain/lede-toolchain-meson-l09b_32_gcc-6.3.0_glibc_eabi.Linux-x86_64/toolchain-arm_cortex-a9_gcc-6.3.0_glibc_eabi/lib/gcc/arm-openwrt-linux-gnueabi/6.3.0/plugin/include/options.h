...
enum opt_code
{
  ...
  OPT_mapcs_float = 1188,                    /* -mapcs-float */
  OPT_mapcs_frame = 1189,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1190,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1191,              /* -mapcs-stack-check */
  OPT_march_ = 1192,                         /* -march= */
  OPT_marm = 1193,                           /* -marm */
  OPT_masm_syntax_unified = 1194,            /* -masm-syntax-unified */
  OPT_mbig_endian = 1195,                    /* -mbig-endian */
  OPT_mbionic = 1196,                        /* -mbionic */
  OPT_mcallee_super_interworking = 1197,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1198,     /* -mcaller-super-interworking */
  OPT_mcpu_ = 1199,                          /* -mcpu= */
  ...
  OPT_mnew_generic_costs = 1211,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1212,                 /* -mold-rtx-costs */
  OPT_mpic_data_is_text_relative = 1213,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1214,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1215,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1216,               /* -mprint-tune-info */
  OPT_mrestrict_it = 1217,                   /* -mrestrict-it */
  OPT_msched_prolog = 1218,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1219,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1220,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1221, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1222,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1223,                         /* -mthumb */
  OPT_mthumb_interwork = 1224,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1225,                  /* -mtls-dialect= */
  OPT_mtp_ = 1226,                           /* -mtp= */
  OPT_mtpcs_frame = 1227,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1228,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1229,                         /* -mtune= */
  OPT_muclibc = 1230,                        /* -muclibc */
  OPT_munaligned_access = 1231,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1232,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1233,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1234,              /* -mword-relocations */
  OPT_n = 1235,                              /* -n */
  OPT_no_canonical_prefixes = 1236,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1237,              /* -no-integrated-cpp */
  OPT_no_pie = 1238,                         /* -no-pie */
